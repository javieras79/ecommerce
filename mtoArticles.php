...
<?php
   if(isset($_GET["editar"])){
     ...
     echo '<form class="form-horizontal" action="toolsArticles.php?editarArticulo=SI&id='.$id.'" method="POST" onsubmit="return validarArticulos();" enctype="multipart/form-data">';
   }else{
     
     echo '<form class="form-horizontal" action="toolsArticles.php?addArticle=SI" method="POST" onsubmit="return validarArticulos();" enctype="multipart/form-data">';
     $activo=0;
     $tablon=0;
   }
?>       
<div class="span12">
    ...
    <br>
    	...
    	<div class="control-group">
    	<label class="control-label" for="articulo">Descripcion <sup>*</sup></label>
    		<div class="controls">
    	...
    	<div class="control-group">
    	<label class="control-label" for="baja">Mostrar Tablon <sup>*</sup></label>
    		<div class="controls">
    		<?php 
    		  if($tablon==0){
    		    echo "<input type='checkbox' id='tablon' name='tablon'>";
    		  }else{
    		    echo "<input type='checkbox' id='activo' name='tablon' value='1' checked>";
    		  }
    		 ?>    		                   
   			</div>
    	</div>
    	<div class="control-group">
    	<label class="control-label" for="articulo">Usuario <sup>*</sup></label>
    		<div class="controls">
    			<input type="text" id="usuario" placeholder="usuario" name="usuario" value="<?php if(isset($_GET["editar"])){echo $usuario;}else{}?>">                   
   			</div>
    	</div>
    	<div class="control-group">
    	<label class="control-label" for="articulo">Fecha <sup>*</sup></label>
    		<div class="controls">
    	 ...
    	 <div class="control-group">
                <div class="controls">
                    <a href="listArticles.php" class="shopBtn btn-large">Volver</a>
