...
INSERT INTO usuarios (`nick`, `password`, `nombre`, `apellidos`, `email`, `direccion`, `provincia`, `poblacion`, `telefono`, `baja`, `id_rol`) VALUES ('javieras', 'jame47l', 'Javier', 'Aznar Serna', 'javieras79@gmail.com', 'Doctor Gregorio Marañon 25', 'Alicante', 'Elche', '680415480', '', '1');
...
INSERT INTO marcas (`nombre_marca`, `baja`) VALUES ('Ging-Gong', '1');
INSERT INTO marcas (`nombre_marca`, `baja`) VALUES ('D-Boys', '1');
INSERT INTO marcas (`nombre_marca`, `baja`) VALUES ('Marui', '1');
INSERT INTO marcas (`nombre_marca`, `baja`) VALUES ('Star', '1');
INSERT INTO marcas (`nombre_marca`, `baja`) VALUES ('Cyma', '1');

INSERT INTO categorias (`nombre_categoria`, `baja`) VALUES ('Replicas', '1');
INSERT INTO categorias (`nombre_categoria`, `baja`) VALUES ('Accesorios', '1');
INSERT INTO categorias (`nombre_categoria`, `baja`) VALUES ('Consumibles', '1');

INSERT INTO subcategorias (`id_categoria`, `nombre_subcategoria`, `baja`) VALUES ('1', 'Fusiles', '1');
INSERT INTO subcategorias (`id_categoria`, `nombre_subcategoria`, `baja`) VALUES ('1', 'Subfusiles', '1');
INSERT INTO subcategorias (`id_categoria`, `nombre_subcategoria`, `baja`) VALUES ('1', 'Pistolas', '1');
INSERT INTO subcategorias (`id_categoria`, `nombre_subcategoria`, `baja`) VALUES ('3', 'Bolas', '1');
INSERT INTO subcategorias (`id_categoria`, `nombre_subcategoria`, `baja`) VALUES ('2', 'Ropa', '1');
...
INSERT INTO articulos (`id_categoria`, `id_subcategoria`, `id_marca`, `nombre_articulo`, `descripcion`, `precio`, `iva`, `baja`, `tablon`) VALUES ('1', '3', '5', 'P226', 'Pistola', '90.00', '21.00', '', '1');
